...
public class ReportSpaceAdapter extends RecyclerView.Adapter<ReportSpaceAdapter.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        ViewHolder(View itemView, int ViewType){
            ...
            main=itemView.findViewById(R.id.report_space_item);
    ...
    public ReportSpaceAdapter(AppCompatActivity activity, ArrayList<Space> items){this.activity=activity; this.items = items;}

    @Override public ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType){
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.report_space_item,parent,false);
